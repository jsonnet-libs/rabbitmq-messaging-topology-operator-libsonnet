---
permalink: /1.16/rabbitmq/v1beta1/queue/
---

# rabbitmq.v1beta1.queue
...
* [`obj spec`](#obj-spec)
  ...
  * [`fn withAutoDelete(autoDelete)`](#fn-specwithautodelete)
  * [`fn withDeleteIfEmpty(deleteIfEmpty)`](#fn-specwithdeleteifempty)
  * [`fn withDeleteIfUnused(deleteIfUnused)`](#fn-specwithdeleteifunused)
  * [`fn withDurable(durable)`](#fn-specwithdurable)
...
### fn spec.withDeleteIfEmpty

```ts
withDeleteIfEmpty(deleteIfEmpty)
```

"when set to true, queues are deleted only if empty."

### fn spec.withDeleteIfUnused

```ts
withDeleteIfUnused(deleteIfUnused)
```
