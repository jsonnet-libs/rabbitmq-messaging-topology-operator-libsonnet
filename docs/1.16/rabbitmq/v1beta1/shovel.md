---
permalink: /1.16/rabbitmq/v1beta1/shovel/
---
...
* [`obj spec`](#obj-spec)
  ...
  * [`fn withDestApplicationPropertiesMixin(destApplicationProperties)`](#fn-specwithdestapplicationpropertiesmixin)
  ...
  * [`fn withDestMessageAnnotations(destMessageAnnotations)`](#fn-specwithdestmessageannotations)
  * [`fn withDestMessageAnnotationsMixin(destMessageAnnotations)`](#fn-specwithdestmessageannotationsmixin)
  * [`fn withDestProperties(destProperties)`](#fn-specwithdestproperties)
  * [`fn withDestPropertiesMixin(destProperties)`](#fn-specwithdestpropertiesmixin)
  ...
  * [`fn withDestPublishPropertiesMixin(destPublishProperties)`](#fn-specwithdestpublishpropertiesmixin)
  * [`fn withDestQueue(destQueue)`](#fn-specwithdestqueue)
  * [`fn withDestQueueArgs(destQueueArgs)`](#fn-specwithdestqueueargs)
  * [`fn withDestQueueArgsMixin(destQueueArgs)`](#fn-specwithdestqueueargsmixin)
  ...
  * [`fn withSrcConsumerArgs(srcConsumerArgs)`](#fn-specwithsrcconsumerargs)
  * [`fn withSrcConsumerArgsMixin(srcConsumerArgs)`](#fn-specwithsrcconsumerargsmixin)
  ...
  * [`fn withSrcQueueArgs(srcQueueArgs)`](#fn-specwithsrcqueueargs)
  * [`fn withSrcQueueArgsMixin(srcQueueArgs)`](#fn-specwithsrcqueueargsmixin)
  ...
  * [`obj spec.rabbitmqClusterReference`](#obj-specrabbitmqclusterreference)
    ...
    * [`fn withNamespace(namespace)`](#fn-specrabbitmqclusterreferencewithnamespace)
...
### fn spec.withDestApplicationPropertiesMixin

```ts
withDestApplicationPropertiesMixin(destApplicationProperties)
```
...
### fn spec.withDestMessageAnnotations

```ts
withDestMessageAnnotations(destMessageAnnotations)
```

"amqp10 configuration"

### fn spec.withDestMessageAnnotationsMixin

```ts
withDestMessageAnnotationsMixin(destMessageAnnotations)
```
...
### fn spec.withDestPropertiesMixin

```ts
withDestPropertiesMixin(destProperties)
```
...
### fn spec.withDestPublishPropertiesMixin

```ts
withDestPublishPropertiesMixin(destPublishProperties)
```
...
### fn spec.withDestQueueArgs

```ts
withDestQueueArgs(destQueueArgs)
```



### fn spec.withDestQueueArgsMixin

```ts
withDestQueueArgsMixin(destQueueArgs)
```
...
### fn spec.withSrcConsumerArgs

```ts
withSrcConsumerArgs(srcConsumerArgs)
```

"amqp091 configuration"

### fn spec.withSrcConsumerArgsMixin

```ts
withSrcConsumerArgsMixin(srcConsumerArgs)
```
...
### fn spec.withSrcQueueArgs

```ts
withSrcQueueArgs(srcQueueArgs)
```



### fn spec.withSrcQueueArgsMixin

```ts
withSrcQueueArgsMixin(srcQueueArgs)
```
