---
permalink: /1.10/rabbitmq/v1beta1/federation/
---

# rabbitmq.v1beta1.federation
...
* [`obj spec`](#obj-spec)
  ...
  * [`fn withExchange(exchange)`](#fn-specwithexchange)
  * [`fn withExpires(expires)`](#fn-specwithexpires)
  * [`fn withMaxHops(maxHops)`](#fn-specwithmaxhops)
  * [`fn withMessageTTL(messageTTL)`](#fn-specwithmessagettl)
  * [`fn withName(name)`](#fn-specwithname)
  * [`fn withPrefetch-Count(prefetch_count)`](#fn-specwithprefetch-count)
  * [`fn withQueue(queue)`](#fn-specwithqueue)
  * [`fn withReconnectDelay(reconnectDelay)`](#fn-specwithreconnectdelay)
  * [`fn withTrustUserId(trustUserId)`](#fn-specwithtrustuserid)
...
new returns an instance of Federation
...
### fn spec.withPrefetch-Count

```ts
withPrefetch-Count(prefetch_count)
```
...
### fn spec.withTrustUserId

```ts
withTrustUserId(trustUserId)
```
