---
permalink: /1.10/rabbitmq/v1alpha1/superStream/
---

# rabbitmq.v1alpha1.superStream
...
* [`obj spec`](#obj-spec)
  ...
  * [`fn withRoutingKeys(routingKeys)`](#fn-specwithroutingkeys)
  * [`fn withRoutingKeysMixin(routingKeys)`](#fn-specwithroutingkeysmixin)
...
new returns an instance of SuperStream
...
### fn spec.withRoutingKeys

```ts
withRoutingKeys(routingKeys)
```
...
### fn spec.withRoutingKeysMixin

```ts
withRoutingKeysMixin(routingKeys)
```
