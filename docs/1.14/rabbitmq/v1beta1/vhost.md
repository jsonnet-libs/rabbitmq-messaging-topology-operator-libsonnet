---
permalink: /1.14/rabbitmq/v1beta1/vhost/
---

# rabbitmq.v1beta1.vhost
...
* [`obj spec`](#obj-spec)
  * [`fn withDefaultQueueType(defaultQueueType)`](#fn-specwithdefaultqueuetype)
...
new returns an instance of Vhost
...
### fn spec.withDefaultQueueType

```ts
withDefaultQueueType(defaultQueueType)
```
