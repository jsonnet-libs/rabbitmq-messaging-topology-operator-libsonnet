{
  ...
  '#spec':: d.obj(help='"PolicySpec defines the desired state of Policy https://www.rabbitmq.com/parameters.html#policies"'),
  spec: {
    '#rabbitmqClusterReference':: d.obj(help='"Reference to the RabbitmqCluster that the exchange will be created in. Required property."'),
    ...
    '#withApplyTo':: d.fn(help="\"What this policy applies to: 'queues', 'exchanges', or 'all'. Default to 'all'.\"", args=[d.arg(name='applyTo', type=d.T.string)]),
    ...
    '#withPattern':: d.fn(help='"Regular expression pattern used to match queues and exchanges, e.g. \\"^amq.\\". Required property."', args=[d.arg(name='pattern', type=d.T.string)]),
    withPattern(pattern): { spec+: { pattern: pattern } },
    '#withPriority':: d.fn(help="\"Default to '0'. In the event that more than one policy can match a given exchange or queue, the policy with the greatest priority applies.\"", args=[d.arg(name='priority', type=d.T.integer)]),
