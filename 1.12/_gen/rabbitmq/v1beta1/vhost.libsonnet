{
  ...
  spec: {
    '#rabbitmqClusterReference':: d.obj(help='"Reference to the RabbitmqCluster that the vhost will be created in. Required property."'),
    ...
    '#withDefaultQueueType':: d.fn(help='"Default queue type for this vhost; can be set to quorum, classic or stream. Supported in RabbitMQ 3.11.12 or above."', args=[d.arg(name='defaultQueueType', type=d.T.string)]),
