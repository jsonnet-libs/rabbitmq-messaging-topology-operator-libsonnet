{
  ...
  spec: {
    ...
    importCredentialsSecret: {
      ...
      withName(name): { spec+: { importCredentialsSecret+: { name: name } } },
    },
    '#rabbitmqClusterReference':: d.obj(help='"Reference to the RabbitmqCluster that the user will be created for. This cluster must\\nexist for the User object to be created."'),
